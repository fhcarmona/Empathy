...
screen about():
    ...
    ## screen.
    use game_menu(_("Sobre"), scroll="none"):

        style_prefix "about"

        vbox xpos 1.0 xanchor 0.5 xsize 0.5:
            ...
            text _("Desenvolvido por {a=https://peralta-games.itch.io/}Peralta Games{/a}.")
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_(""), auto=_("Salvamento automático"), quick=_("Salvamento rápido"))
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança o diálogo e executa uma ação.")

    hbox:
        label _("Espaço")
        text _("Avança o diálogo sem selecionar uma opção.")

    hbox:
        label _("Setas")
        text _("Navegação pela interface.")
    ...
    hbox:
        label _("Page Up")
        text _("Sobe o texto de diálogo.")
...
screen mouse_help():
    ...
    hbox:
        label _("Botão da Esquerda")
        text _("Avança um diálogo e executa uma ação.")
    ...
    hbox:
        label _("Botão da Direita")
        text _("Acessa o menu do jogo.")

    hbox:
        label _("Roda do Mouse Cima")
        text _("Rola para o diálogo anterior.")

    hbox:
        label _("Roda do Mouse Baixo")
        text _("Rola para o diálogo posterior.")
...
screen confirm(message, yes_action, no_action):
    ...
    frame:
        ...
        vbox:
            ...
            label _("Certeza que deseja fazer esta ação?"):
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Pular Diálogo") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Auto") action Preference("auto-forward", "toggle")
