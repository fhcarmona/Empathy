...
label scene_0003:
    ...
    $ narrative_image("p02", right, None, p02, "NÃO!")
    $ narrative_image("p02", right, None, p02, "VOCÊ NÃO ENTENDE!")
    $ narrative_image("psi sad", left, None, psi, "[p02_nome], se acalme...")
    $ narrative_image("psi sad", left, None, psi, "SEGURANÇA!")
    $ narrative_image("seg", right, None, seg, "SAI DE PERTO DELA!")
    $ narrative_image("psi sad", left, None, seg, "Minha... garganta")
