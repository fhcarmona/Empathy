...
label scene_0005:
    ...
    $ narrative_image("psi", left, None, psi, "Foi definido por uma decisão jurídica que ele deveria buscar uma psiquiatra")
    ...
    $ narrative_image("i01", right, None, i01, "Como imaginávamos [i02_nome]...")
